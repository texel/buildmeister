...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.rdoc", "Rakefile", "bin/buildmeister", "config/buildmeister_config.sample.yml", "lib/buildmeister.rb", "test/test_buildmeister.rb"]
  s.has_rdoc = true
